...
public class Point2D {
	...
	public void accept() {
		...
		System.out.println("Enter Xaxis point");
		Xaxis = pt.nextDouble();
		System.out.println("Enter Yaxis point");
		Yaxis = pt.nextDouble();
	}
	...
	public void calculateDistance(Point2D p2) {
		...
		System.out.println("distance between points : " + "(" + this.Xaxis + "," + this.Yaxis + ")" + "  and " + "("
				+ p2.Xaxis + "," + p2.Yaxis + ")" + " = " + distance);
	}
}
